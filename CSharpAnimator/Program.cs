...
namespace CSharpAnimator
{
    class Program
    {
        ...
        static public void FileWrite(bool menus)
        {
            ...
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("Saved! Do you want to watch your animation now? (yes/no)");
        ...
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("Created by drenewoo (Wojciech Wójtowicz)" + "\n" + "CSharp Animator " + Version + "  Frame:" + v +"\n" + "\n");
        ...
        static void Menu(int k)
        {
            ...
            int x = 5;
                ...
                Console.Clear();
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Created by drenewoo (Wojciech Wójtowicz)" + "\n" + "CSharp Animator " + Version + "  Frame:" + k +"\n" + "\n");
                Console.BackgroundColor = ConsoleColor.Blue;
                ...
                Console.WriteLine("Restart animation    ");
                if (x == 7)
                {
                    Console.ForegroundColor = ConsoleColor.White;
                }
                ...
                Console.WriteLine("Exit to editor       ");
                if (x == 9)
                {
                    Console.ForegroundColor = ConsoleColor.White;
                }
        ...
        static void testanim()
        {
            ...
            Console.WriteLine("To get info, press escape, then use arrows to make cursor choosing info and then press b    or if you know how to steer, make what you want");
            Console.Write("avaiable colors:" + " ");
            ...
            Console.BackgroundColor = ConsoleColor.Blue;
            Console.ForegroundColor = ConsoleColor.Black;      
            Console.WriteLine("\n" + " Play  | save |info|  Text mode  |" + "color:"+colore+"  |"+"                                                                              ");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.ForegroundColor = ConsoleColor.White;
                    ...
                    while(true)
                    {
                        ...
                        if (ckm.Key == ConsoleKey.B)
                        {
                            ...
                            else if (xm >= 8 && xm <= 14)
                            {
                                Console.Clear();
                                save = true;
                                Console.WriteLine("Txt file path (if not exist, program will automaticaly create file):");
                                sciezka = Console.ReadLine();
                            ...
                            {
                                Console.Clear();
                                Console.WriteLine("\n" + "Welcome in CSharp Animator. Here you have basics. " + "\n" + "\n" + "Avaiable colors:" + "\n");
                                ...
                                clinfo = 0;
                                Console.ForegroundColor = ConsoleColor.White;
                                Console.WriteLine("sterring in editor: sterring - arrows, draw - B, erease - N, change frame - z/x, change color - c/v; Top menu - esc, sterring - arrows, Choose - b, exit from top menu - esc | Player: entering top menu - esc, sterring - arrows, choose - b");
                                Console.WriteLine("Text Mode - compatibility mode, here you can paste animation code throught Ctrl+V");
